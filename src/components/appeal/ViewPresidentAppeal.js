...
import searchPresidentAppealByID from '../../axios/presidentAppeal/searchByID';
...
const ViewPresidentAppeal = props => {
	...
	useEffect(async () => {
		await searchPresidentAppealByID(
		...
		<div className={classes.root}>
			<Card>
				<CardHeader
					...
					title="⚠️ রাষ্ট্রপতির নিকট আপিল আবেদন"
					subheader={`মামলা নংঃ ${appeal.case}`}
				/>
			</Card>
			<br />
			<br />
...
export default ViewPresidentAppeal;
