...
import searchInvestigationReportGDByID from '../../../axios/InvestigationReportGD/searchByID';
...
const InvestigationView_gd = props => {
	...
	useEffect(async () => {
		await searchInvestigationReportGDByID(
...
export default InvestigationView_gd;
