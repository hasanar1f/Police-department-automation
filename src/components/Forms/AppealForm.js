...
import createAppeal from '../../axios/appeal/create';
								...
								<div className={classes.wrap}>
									<div className={classes.box}>
										<AccordionDetails>
											<div>
												<input
													key="Appeal_form_scan_copy"
													type="file"
													accept="image/*"
													style={{ display: 'none' }}
													id="Appeal_form_scan_copy"
													onChange={e => handleScanCopyUpload(e)}
												/>
												<label htmlFor="Appeal_form_scan_copy">
													<Button
														key="Appeal_form_scan_copy-button"
														variant="contained"
														color="primary"
														component="span"
													>
