...
import createPresidentAppealVerdict from '../../axios/presidentAppealVerdict/create';
	...
	const onSubmit = async data => {
		if (scanCopy.length < 1) {
			...
			await upload(
				...
				{
					directory: '/presidentAppeal/verdict/primary'
				},
				(res, err) => {
					primaryDocument = res;
				}
			...
			await createPresidentAppealVerdict(
				{
					case: data['case_no'],
					date: data['appeal_verdict_date'],
					president: data['president_name'],
				...
				async (res, err) => {
					if (res) {
						await updateCaseTimeline(
							...
							{
								toPush: {
									documentType: 'President Appeal Verdict',
									id: res.id,
							...
							<Accordion>
								...
								>
									<Typography className={classes.heading}>
										রাষ্ট্রপতির নিকট ক্ষমা আবেদনের রায়
									</Typography>
								</AccordionSummary>
								<div className={classes.wrap}>
									<div className={classes.box}>
										...
										<AccordionDetails>
											...
											>
												রাষ্ট্রপতি কর্তৃক ক্ষমা প্রদান?
											</Typography>
											<Controller
												name={'appeal_approve'}
												control={control}
...
export default PresidentVerdictForm;
